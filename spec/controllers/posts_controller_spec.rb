...
describe PostsController do
  describe "GET show" do
    it "redirects to TopicsController if the post is a topic" do
      ...
      expect(Post).to receive(:find).with('42').and_return(topic)
      get :show, id: '42'
    ...
    it "redirects to RepliesController if the post is a reply" do
      ...
      expect(Post).to receive(:find).with('42').and_return(reply)
      get :show, id: '42'
    ...
    it "raises an error if it matches a non-topic or a non-reply" do
      expect(Post).to receive(:find).with('42').and_return Object.new
